...
public class DataTableData {
  ...
  public static List<Population> Generate() {
    ...
    for (int i = 0; i < plist.Count; i++) {
      ...
      if (p.city == "Seoul") {
        p.extraText = "Seoul (서울 – officially the Seoul Special City – is the capital and largest metropolis of South Korea, forming the heart of the Seoul Capital Area, which includes the surrounding Incheon metropolis and Gyeonggi province, the world's second largest metropolitan area with over 25.6 million people.";
      }
      if (p.city == "Tokyo") {
        p.extraText = "Officially Tokyo Metropolis (東京都 Tōkyō-to), is one of the 47 prefectures of Japan, and is both the capital and largest city of Japan.";
      }
      if (p.city == "Delhi") {
        p.extraText = "Delhi, officially the National Capital Territory of Delhi, is the capital territory of India.";
      }
      if (p.city == "Shanghai") {
        p.extraText = "Shanghai is the largest Chinese city by population and the largest city proper by population in the world.  It is a global financial center, and a transport hub with the world's busiest container port.";
      }
    }
